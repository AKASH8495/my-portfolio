  ...
  return (
    <div id='skills' className='lg:mt-40 mt-32 lg:mb-0 mb-20'>
        ...
        <div className='flex flex-wrap items-center justify-center mt-10 lg:w-[80%] mx-auto lg:px-0 px-[20px]'>
            ...
            <img src={githubg} className='lg:w-[150px] w-[80px]' alt='github' />
            <img src={materalUi} className='lg:w-[150px] w-[80px]' alt='materalUi' />
            <img src={figma} className='lg:w-[150px] w-[80px]' alt='figma' />
        </div>
