...
const HeroSection = () => {
  ...
  const resumePdfUrl = "https://drive.google.com/file/d/1kLv7ajdFiuukhQdWRBNu20TapYzmn02D/view?usp=drive_link";

  const linkedinUrl = "https://www.linkedin.com/in/akashchavan1/";
  const githubUrl = "https://github.com/AKASH8495";
  const instagramUrl = "https://www.instagram.com/your-instagram-username";
    ...
    <div id="herosection" className="text-white max-w-[1130px] lg:mx-auto mt-10 lg:mt-10 flex flex-col relative">
      ...
      <div className="mt-10 lg:w-[50%] w-full leading-[30px] lg:px-0 px-[20px] ">
        <p className="text-gray-400">
          Hello There ! I'm Akash Chavan Frontend Developer <br></br> I'm thrill
